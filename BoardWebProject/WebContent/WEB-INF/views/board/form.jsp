							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-description">
										대덕인재개발원 종합 테스트
										<code>게시판 등록 페이지를 작성합니다.</code>
									</p>
									<form class="forms-sample" action="/board/insert.do" method="post" id="frm">
										<div class="form-group">
											<input type="text" class="form-control" id="title" name="bo_title" placeholder="제목을 입력해주세요.">
										</div>
										<div class="form-group">
											<textarea class="form-control" id="content" rows="10" name="bo_content" placeholder="내용을 입력해주세요."></textarea>
										</div>
										<div class="form-group">
											<button type="button" class="btn btn-outline-info btn-fw" id="addBtn">등록</button>
											<button type="button" class="btn btn-outline-primary btn-fw" onclick="javascript:location.href='/board/list.do'">목록</button>
										</div>
									</form>
								</div>
							</div>
...
$(function(){
	var addBtn = $("#addBtn");   //버튼 Element 얻어옴
